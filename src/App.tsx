...
function timelinePosition(event: EventItem) {
  ...
  const durationMinutes = TIMELINE_END_MINUTES - TIMELINE_START_MINUTES
  const top = (visibleStart - TIMELINE_START_MINUTES) / durationMinutes * 100
  ...
  return (
    <div className="week-view">
      ...
      <div className="week-body">
        <div className="times">{TIMELINE_LABEL_HOURS.map((hour) => <span key={hour} style={{ top: `${(hour * 60 - TIMELINE_START_MINUTES) / (TIMELINE_END_MINUTES - TIMELINE_START_MINUTES) * 100}%` }}>{timelineLabel(hour)}</span>)}</div>
    ...
    <div className="day-view">
      ...
      <div className="day-timed">
        <div className="day-timeline">
          {TIMELINE_LABEL_HOURS.map((hour) => <div className="time-row" key={hour} style={{ top: `${(hour * 60 - TIMELINE_START_MINUTES) / (TIMELINE_END_MINUTES - TIMELINE_START_MINUTES) * 100}%` }}><span>{timelineLabel(hour)}</span><i /></div>)}
        </div>

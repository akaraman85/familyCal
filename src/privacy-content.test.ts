...
assert.match(html, /Sharing, transfer, and disclosure of Google user data/)
assert.match(html, /Data protection for sensitive data/)
assert.match(html, /Limited use of Google user data/)
assert.match(html, /Google User Data Policy/)

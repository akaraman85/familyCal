...
assert.match(robots, /^Disallow: \/calendar$/m)
assert.match(robots, /^Disallow: \/agenda$/m)
assert.match(robots, /^Disallow: \/todos$/m)
assert.match(robots, /^Disallow: \/integrations$/m)
assert.match(robots, /^Disallow: \/family$/m)
